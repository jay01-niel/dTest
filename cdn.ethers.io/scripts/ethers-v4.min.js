! function(e) {
    ...
    return function o(s, a, u) {
        ...
        4: [function(e, t, r) {
            ...
            function w(o, e, s) {
                ...
                return function() {
                    ...
                    var i = {},
                        r = null;
                    if (e.length === a.inputs.length + 1 && "object" == typeof e[e.length - 1])
                        for (var n in null != (i = p.shallowCopy(e.pop())).blockTag && (r = i.blockTag), delete i.blockTag, i)
        ...
        8: [function(e, C, L) {
            ...
            ! function(e) {
                ...
                k.prototype._prepare = function() {
                    ...
                    for (var l = 1; l < e; l++)
                        for (var h = 0; h < 4; h++) s = this._Kd[l][h], this._Kd[l][h] = _[s >> 24 & 255] ^ M[s >> 16 & 255] ^ A[s >> 8 & 255] ^ E[255 & s]
        ...
        9: [function(A, e, t) {
            ! function(e, t) {
                ...
                m.isBN = function(e) {
                    ...
                    var i, o, s = 0;
                    if ("be" === r)
                        for (n = e.length - 1, i = 0; 0 <= n; n -= 3) o = e[n] | e[n - 1] << 8 | e[n - 2] << 16, this.words[i] |= o << s & 67108863, this.words[i + 1] = o >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, i++);
                    else if ("le" === r)
                        for (i = n = 0; n < e.length; n += 3) o = e[n] | e[n + 1] << 8 | e[n + 2] << 16, this.words[i] |= o << s & 67108863, this.words[i + 1] = o >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, i++);
                    return this.strip()
                ...
                Math.imul || (o = i), m.prototype.mulTo = function(e, t) {
                    ...
                    for (var u = r.clone(), l = t.clone(); !t.isZero();) {
                        ...
                        if (0 < h)
                            for (t.iushrn(h); 0 < h--;)(n.isOdd() || i.isOdd()) && (n.iadd(u), i.isub(l)), n.iushrn(1), i.iushrn(1);
                        for (var c = 0, d = 1; 0 == (r.words[0] & d) && c < 26; ++c, d <<= 1);
                        if (0 < c)
                            for (r.iushrn(c); 0 < c--;)(o.isOdd() || s.isOdd()) && (o.iadd(u), s.isub(l)), o.iushrn(1), s.iushrn(1);
                    ...
                    for (var n, i = new m(1), o = new m(0), s = r.clone(); 0 < t.cmpn(1) && 0 < r.cmpn(1);) {
                        ...
                        if (0 < a)
                            for (t.iushrn(a); 0 < a--;) i.isOdd() && i.iadd(s), i.iushrn(1);
                        for (var l = 0, h = 1; 0 == (r.words[0] & h) && l < 26; ++l, h <<= 1);
                        if (0 < l)
                            for (r.iushrn(l); 0 < l--;) o.isOdd() && o.iadd(s), o.iushrn(1);
        ...
        17: [function(e, t, r) {
            ...
            i(a, o), (t.exports = a).prototype._getEndomorphism = function(e) {
                ...
                for (var t, r, n, i, o, s, a, u, l, h = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), f = e, c = this.n.clone(), d = new _(1), p = new _(0), v = new _(0), y = new _(1), m = 0; 0 !== f.cmpn(0);) {
                    ...
                    var b = y.sub(g.mul(p));
                    if (!n && u.cmp(h) < 0) t = a.neg(), r = d, n = u.neg(), i = l;
                    else if (n && 2 == ++m) break;
            ...
            n.assert = o, n.toArray = s.toArray, n.zero2 = s.zero2, n.toHex = s.toHex, n.encode = s.encode, n.getNAF = function(e, t, r) {
                ...
                for (var n = 0, i = 0; 0 < e.cmpn(-n) || 0 < t.cmpn(-i);) {
                    var o, s, a, u = e.andln(3) + n & 3,
                        l = t.andln(3) + i & 3;
                    if (3 === u && (u = -1), 3 === l && (l = -1), 0 == (1 & u)) o = 0;
                    else o = 3 !== (a = e.andln(7) + n & 7) && 5 !== a || 2 !== l ? u : -u;
                    if (r[0].push(o), 0 == (1 & l)) s = 0;
                    else s = 3 !== (a = t.andln(7) + i & 7) && 5 !== a || 2 !== u ? l : -l;
                ...
                ! function() {
                    ...
                    m.prototype.update = function(e) {
                        ...
                        for (var r, n, i = e.length, o = this.blocks, s = this.byteCount, a = this.blockCount, u = 0, l = this.s; u < i;) {
                            if (this.reset)
                                for (this.reset = !1, o[0] = this.block, r = 1; r < a + 1; ++r) o[r] = 0;
                            if (t)
                                for (r = this.start; u < i && r < s; ++u) o[r >> 2] |= e[u] << h[3 & r++];
                            else
                                for (r = this.start; u < i && r < s; ++u)(n = e.charCodeAt(u)) < 128 ? o[r >> 2] |= n << h[3 & r++] : (n < 2048 ? o[r >> 2] |= (192 | n >> 6) << h[3 & r++] : (n < 55296 || 57344 <= n ? o[r >> 2] |= (224 | n >> 12) << h[3 & r++] : (n = 65536 + ((1023 & n) << 10 | 1023 & e.charCodeAt(++u)), o[r >> 2] |= (240 | n >> 18) << h[3 & r++], o[r >> 2] |= (128 | n >> 12 & 63) << h[3 & r++]), o[r >> 2] |= (128 | n >> 6 & 63) << h[3 & r++]), o[r >> 2] |= (128 | 63 & n) << h[3 & r++]);
                    ...
                    if (t) _.exports = l;
                        ...
                        for (c = 0; c < f.length; ++c) e[f[c]] = l[f[c]]
                }()
        ...
        44: [function(e, r, o) {
            (function(n) {
                ...
                function e(o, e, s, a, u, l, h) {
                    ...
                    var d, p, v = new Uint32Array(64 * a),
                    ...
                    return c.resolveProperties({
                        ...
                        return y.poll(function() {
                            return n.perform("getTransaction", r).then(function(e) {
                                ...
                                else if (null == r.confirmations) return n._getFastBlockNumber().then(function(e) {
        ...
        52: [function(e, t, r) {
            ...
            var v, y = (v = s.BaseProvider, i(m, v), m.prototype.perform = function(e, t) {
                var r = this,
                    n = this.baseUrl,
                    i = "";
                ...
                switch (this.apiKey && (i += "&apikey=" + this.apiKey), e) {
                    ...
                    case "call":
                        if (n += "/api?module=proxy&action=eth_call" + (s = (s = f(t.transaction)) && "&" + s), "latest" !== t.blockTag) throw new Error("EtherscanProvider does not support blockTag for call");
                        return o(n += i);
                    case "estimateGas":
                        var s;
        ...
        53: [function(e, t, r) {
            ...
            var l, h = (l = s.BaseProvider, i(f, l), Object.defineProperty(f.prototype, "providers", {
                get: function() {
        ...
        57: [function(e, t, r) {
            ...
            function S(e, t) {
                var n = this;
                if ("string" == typeof e && null === t && f.getNetwork(e) && (t = e, e = null), t) n = M.call(this, t) || this;
                else {
        ...
        59: [function(e, t, r) {
            ...
            var x, P = (i(I, x = _), I.prototype.encode = function(t) {
                try {
            ...
            var L, D = (i(B, L = _), B.prototype.encode = function(t) {
            ...
            var U, F = (i(j, U = _), j.prototype.encode = function(t) {
                var e = new Uint8Array(32);
                try {
            ...
            var Q, Y = (i(ee, Q = _), ee.prototype.encode = function(e) {
                ...
                var t = this.length,
                    r = new Uint8Array(0); - 1 === t && (t = e.length, r = R.encode(t)), l.checkArgumentCount(t, e.length, " in coder array" + (this.localName ? " " + this.localName : ""));
        ...
        76: [function(e, t, r) {
            ...
            r.encode = function(e) {
                return o.hexlify(function t(e) {
                    ...
                    var n, i = Array.prototype.slice.call(o.arrayify(e));
        ...
        83: [function(e, t, r) {
            ...
            r.serialize = function(r, e) {
                ...
                if (r.r = h.hexZeroPad(t[7], 32), r.s = h.hexZeroPad(t[8], 32), l.bigNumberify(r.r).isZero() && l.bigNumberify(r.s).isZero()) r.chainId = r.v, r.v = 0;
                else {
            ...
            r.fetchJson = function(e, a, u) {
                ...
                if ("string" == typeof e) l = e;
                    ...
                    if (null == e.url && c.throwError("missing URL", c.MISSING_ARGUMENT, {
                        ...
                        for (var t in e.headers) r[t.toLowerCase()] = {
                            key: t,
